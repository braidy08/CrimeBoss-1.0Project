...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void IntelLevelChanged(UMETA_BaseMission* inMissionID, int32 inIntelValue, EMETA_IntelUnlockLevel inNewLevel);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void GatheringIntelCompleted(UMETA_BaseMission* inMissionID);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void BossLevelChanged(int32 inPreviousLvl, int32 inCurrentLvl, float inPreviousPoints, float inCurrentPoints);
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void BMWeaponEventStarted();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void BMWeaponEventFinished();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void BMWeaponEventExpired();
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    void AccumulatedBossPointsChanged(float inPreviousValue, float inCurrentValue);
