...
bool UMETA_RandEventManagerComponent::ShouldStateChangeBeNoted_Implementation(FMETA_HeisterStateChangeNote inNote) {
    return false;
}
...
TArray<EMETA_CharacterState> UMETA_RandEventManagerComponent::GetStatesWhichChangesShouldBeNotedInHistory_Implementation() {
...
FMETA_CharacterID UMETA_RandEventManagerComponent::GetMissingHeisterForMission(TSubclassOf<UMETA_MissionID> inMissionID) {
    return FMETA_CharacterID{};
}

FGameplayTag UMETA_RandEventManagerComponent::GetEventIdForMissingHeister(FMETA_CharacterID inCharacterID) {
    return FGameplayTag{};
}

void UMETA_RandEventManagerComponent::GetEventDataForMissingHeister(FMETA_CharacterID inCharacterID, FMETA_MissingHeisterEventData& outData, bool& outSuccess) {
}
