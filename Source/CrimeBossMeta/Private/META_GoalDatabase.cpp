...
void UMETA_GoalDatabase::GetGoalIDByGraph(UObject* inWCO, TSoftObjectPtr<UMETA_BaseStoryGraph> inGraph, bool& outSucceeded, TSubclassOf<UMETA_BaseGoal>& outClass) {
}
