...
void UMETA_GoalManagerComponent::TryToAddFinishedTasksToGoalByGraph_Implementation(const TSoftObjectPtr<UMETA_BaseStoryGraph>& Graph) {
}

void UMETA_GoalManagerComponent::ResetGoalByGraph_Implementation(UMETA_BaseStoryGraph* Graph, EMETA_GoalStatus Result) {
}
...
void UMETA_GoalManagerComponent::RemoveGoalTaskByGraph(TSoftObjectPtr<UMETA_BaseStoryGraph> Graph, UMETA_TaskCondition* Task, bool& bSuccess) {
}
...
TArray<UMETA_BaseGoal*> UMETA_GoalManagerComponent::GetCurrentGoals() {
...
void UMETA_GoalManagerComponent::GetCurrentGoalByGraph(TSoftObjectPtr<UMETA_BaseStoryGraph> inGraph, UMETA_BaseGoal*& outGoal) {
}
...
void UMETA_GoalManagerComponent::AddGoalTaskByGraph(TSoftObjectPtr<UMETA_BaseStoryGraph> Graph, UMETA_TaskCondition* Task, bool& bSuccess) {
}
