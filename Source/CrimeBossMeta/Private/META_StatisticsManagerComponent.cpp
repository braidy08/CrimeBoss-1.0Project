...
void UMETA_StatisticsManagerComponent::SetStatisticFromLoad(TMap<int32, FMETA_StatisticNoteSaveData> inStatistic) {
}
...
FMETA_StatisticNoteSaveData UMETA_StatisticsManagerComponent::GetStatisticForInteraval(int32 inStartDay, int32 inEndDay) {
    return FMETA_StatisticNoteSaveData{};
}

FMETA_StatisticNoteSaveData UMETA_StatisticsManagerComponent::GetStatisticByDay(int32 inDay) {
    return FMETA_StatisticNoteSaveData{};
}

FMETA_StatisticNoteSaveData UMETA_StatisticsManagerComponent::GetFullStatistic() {
    return FMETA_StatisticNoteSaveData{};
}
...
void UMETA_StatisticsManagerComponent::AddMoneyChangesToStatistic(int32 inStartMoney, int32 inEndMoney) {
}
...
void UMETA_StatisticsManagerComponent::AddFinishedPlotlineToStatistic(TSoftObjectPtr<UMETA_BaseStoryGraph> inGraphs) {
}
...
void UMETA_StatisticsManagerComponent::AddBossDataToStatistic(UMETA_BossLevelData* inBossData) {
}
