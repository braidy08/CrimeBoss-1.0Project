...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void RemoveGameplayTagCounted(FGameplayTag inTagToRemove, int32 inNewCount, bool inRemoveTimed);
...
protected:
    ...
    void Multicast_CarryableDamaged(FVector inOffset, AActor* inDamageCauser);
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void AddGameplayTagCounted(FGameplayTag inTagToAdd, int32 inNewCount, bool inRemoveTimed);
