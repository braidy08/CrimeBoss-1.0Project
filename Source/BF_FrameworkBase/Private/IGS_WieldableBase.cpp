...
void AIGS_WieldableBase::ThrowAway_Implementation() {
}
...
void AIGS_WieldableBase::Drop_Implementation() {
}
...
bool AIGS_WieldableBase::CanThrowAway_Implementation() {
    return false;
}
...
bool AIGS_WieldableBase::CanDropOrThrowInternal() {
    return false;
}

bool AIGS_WieldableBase::CanDrop_Implementation() {
    return false;
}
