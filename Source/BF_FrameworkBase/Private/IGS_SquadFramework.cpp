...
TArray<AIGS_GameCharacterFramework*> AIGS_SquadFramework::GetSquadMembers() {
...
int32 AIGS_SquadFramework::GetMemberCount() {
    return 0;
}

int32 AIGS_SquadFramework::GetAliveMemberCount() {
    return 0;
}
