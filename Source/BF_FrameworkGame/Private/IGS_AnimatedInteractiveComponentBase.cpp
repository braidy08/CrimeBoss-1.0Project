...
void UIGS_AnimatedInteractiveComponentBase::StopAnimation() {
}

void UIGS_AnimatedInteractiveComponentBase::StartAnimation() {
}
...
void UIGS_AnimatedInteractiveComponentBase::ReleaseInput() {
}
