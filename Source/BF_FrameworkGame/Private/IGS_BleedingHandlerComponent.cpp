...
void UIGS_BleedingHandlerComponent::Multicast_Die_Implementation(float inHealthChanged, float inShieldChanged, bool inShouldGib, const FIGS_HitInfo& inHitInfo) {
}
bool UIGS_BleedingHandlerComponent::Multicast_Die_Validate(float inHealthChanged, float inShieldChanged, bool inShouldGib, const FIGS_HitInfo& inHitInfo) {
    return true;
}
