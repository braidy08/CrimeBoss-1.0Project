...
AIGS_ThrowableProjectileBase::AIGS_ThrowableProjectileBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->mR_InitialThrowSpeed = 1.00f;
...
void AIGS_ThrowableProjectileBase::OnRep_Velocity() {
}
...
void AIGS_ThrowableProjectileBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    ...
    DOREPLIFETIME(AIGS_ThrowableProjectileBase, mR_InitialThrowSpeed);
    DOREPLIFETIME(AIGS_ThrowableProjectileBase, mR_InitialVelocity);
    DOREPLIFETIME(AIGS_ThrowableProjectileBase, mR_RandomThrowRotation);
    ...
    DOREPLIFETIME(AIGS_ThrowableProjectileBase, mR_bWasThrown);
