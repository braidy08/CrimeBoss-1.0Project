...
bool UIGS_BadFlyGameplayStatics::IsTearingDown(UObject* inCaller) {
    return false;
}
...
int32 UIGS_BadFlyGameplayStatics::GetTotalWeightSpawned(UObject* inWCO) {
    return 0;
}
...
UIGS_MenuNavigationManager* UIGS_BadFlyGameplayStatics::GetMenuNavigationManager(AGameStateBase* inGameState) {
    return NULL;
}
...
UTexture2D* UIGS_BadFlyGameplayStatics::GetCharacterPicture(UObject* inWCO, EIGS_CharacterID inCharacterID, bool bIsMaxLeveled, int32 inGenericID) {
    return NULL;
}
