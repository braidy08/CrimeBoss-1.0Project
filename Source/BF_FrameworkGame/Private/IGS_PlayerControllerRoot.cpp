...
AIGS_PlayerControllerRoot::AIGS_PlayerControllerRoot(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bGamepadPrioritizeUseInsteadOfReload = false;
    this->HoldTimeInSeconds = 0.30f;
    this->StartHeistHoldTimeInSeconds = 2.00f;
    this->DoubleClickThresholdInSeconds = 0.20f;
...
float AIGS_PlayerControllerRoot::GetDoubleClickInSeconds() const {
    return 0.0f;
}
