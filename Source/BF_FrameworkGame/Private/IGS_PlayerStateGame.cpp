...
void AIGS_PlayerStateGame::SendTextChatMessage_Implementation(const FText& InText) {
}
bool AIGS_PlayerStateGame::SendTextChatMessage_Validate(const FText& InText) {
    return true;
}
