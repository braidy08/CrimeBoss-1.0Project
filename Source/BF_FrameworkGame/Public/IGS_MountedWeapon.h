...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_MountedGunUser, meta=(AllowPrivateAccess=true))
    AIGS_GameCharacterFramework* mR_RemoteMountedGunUser;
