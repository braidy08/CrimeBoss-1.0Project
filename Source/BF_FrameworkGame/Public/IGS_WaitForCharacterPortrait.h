...
public:
    ...
    static UIGS_WaitForCharacterPortrait* WaitForCharacterPortrait(UObject* inWorldContextObject, EIGS_CharacterID inCharacterID, bool inIsMaxLeveled, int32 inGenericID, int32 inMutableIndex);
