...
class UIGS_TrafficDirectionLocks;
class UIGS_TrafficPathComponentFramework;
class UIGS_TrespassersInfo;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<UIGS_TrafficPathComponentFramework*, UIGS_TrespassersInfo*> m_Trespassers;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<UIGS_TrafficPathComponentFramework*, UIGS_TrafficDirectionLocks*> m_DirectionLocks;
