...
class UIGS_MenuNavigationManager;
...
public:
    ...
    static bool IsTearingDown(UObject* inCaller);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 GetTotalWeightSpawned(UObject* inWCO);
    ...
    UFUNCTION(BlueprintCallable)
    static UIGS_MenuNavigationManager* GetMenuNavigationManager(AGameStateBase* inGameState);
    ...
    UFUNCTION(BlueprintCallable)
    static UTexture2D* GetCharacterPicture(UObject* inWCO, EIGS_CharacterID inCharacterID, bool bIsMaxLeveled, int32 inGenericID);
