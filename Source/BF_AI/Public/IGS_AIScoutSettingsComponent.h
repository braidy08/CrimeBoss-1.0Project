...
class BF_AI_API UIGS_AIScoutSettingsComponent : public UIGS_AISettingsComponent, public IIGS_PrimaryWeaponSettingsInterface, public IIGS_MeleeWeaponSettingsInterface, public IIGS_WeaponSettingsInterface, public IIGS_CombatRangeSettingsInterface, public IIGS_ReactionsSettingsInterface, public IIGS_ThrowableWeaponSettingsInterface {
    GENERATED_BODY()
public:
