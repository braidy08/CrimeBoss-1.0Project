...
class BF_AI_API UIGS_AIShielderSettingsComponent : public UIGS_AISettingsComponent, public IIGS_CombatRangeSettingsInterface, public IIGS_SecondaryWeaponSettingsInterface, public IIGS_WeaponSettingsInterface, public IIGS_MeleeWeaponActivationSettingsInterface, public IIGS_ShielderSettingsInterface {
    GENERATED_BODY()
public:
