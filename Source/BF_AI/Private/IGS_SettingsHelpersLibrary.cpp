...
float UIGS_SettingsHelpersLibrary::GetCombatRangeMin(AIGS_AIControllerGame* Controller) {
    return 0.0f;
}

float UIGS_SettingsHelpersLibrary::GetCombatRangeMax(AIGS_AIControllerGame* Controller) {
    return 0.0f;
}
