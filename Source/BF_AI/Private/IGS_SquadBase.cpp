...
FVector AIGS_SquadBase::GetSquadMeanLocation() {
    return FVector{};
}

AIGS_GameCharacterFramework* AIGS_SquadBase::GetRandomMember() {
    return NULL;
}

AIGS_GameCharacterFramework* AIGS_SquadBase::GetNearestMember(FVector Pos, TArray<AIGS_GameCharacterFramework*> excludeCharacters) {
    return NULL;
}

AIGS_GameCharacterFramework* AIGS_SquadBase::GetNearestAliveMember(FVector Pos, TArray<AIGS_GameCharacterFramework*> excludeCharacters) {
    return NULL;
}

AIGS_GameCharacterFramework* AIGS_SquadBase::GetCenterMember() {
    return NULL;
}
