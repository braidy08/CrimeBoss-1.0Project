...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<EMETA_AIBossStrengthChangeIntensity, int32> StrengthChangeIntensityConfig;
...
public:
    ...
    float RandomizeSoldiersCasualtiesInPercentsAfterNeutralAttack();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_UIArmySizeConfig GetUIArmySizeConfig();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_TurfMissionDifficulty GetTurfMissionDifficulty(int32 inAiArmySize);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_Interval GetTileStrengthInterval();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_Interval GetTileStartingBaseStrength();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetTileCurrentStrengthChangeWhenPlayerWinsDefense();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetTileCurrentStrengthChangeWhenPlayerLosesAttack();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakWhenAIBossHasOnly3Tiles();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakWhenAIBossHasOnly2Tiles();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakWhenAIBossHasDifferentAmountOfTiles();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_Interval GetStrengthTweaksIntervalForAIBossAfterTerritoryChanges();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakForAIBossAfterTileLosingToPlayer();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakForAIBossAfterTileLosingToAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakForAIBossAfterTileCapturingFromPlayer();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthTweakForAIBossAfterTileCapturingFromAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthChangeIntensity(EMETA_AIBossStrengthChangeIntensity inIntensity);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthChangeIfWillCreateIsolatedTile();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthChangeIfTileIsolated();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetStrengthChangeIfTileConnected();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetRandomizedValidTileGroup();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetRandomizedPlayersInitialTerritory();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    TArray<FGameplayTagContainer> GetPlayersInitialTileGroups();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetPlayersInitialSoldiersAmount();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_ArmyTier GetPlayersInitialArmyTier();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetPlayersAttack_MaxConcurrentlySpawnedPlayerSoldiersOnLastTile();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetPlayersAttack_MaxConcurrentlySpawnedAISoldiersOnLastTile();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetPlayersArmyLimit(EMETA_RespectLvl inPlayerRespect);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_PlayerEndAgonyConfig GetPlayerEndAgonyConfig() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetNumberOfEnemySoldiersMultiplier();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetMinAmountOfSoldiersForAttackAndDefence(EMETA_RespectLvl inRespectLvl, int32& outMinForAttack, int32& outMinForDefence);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_ArmyTier GetMaxArmyTierForInnerUpgrades();
    
    UFUNCTION(BlueprintCallable)
    FMETA_GangInitialConfiguration GetGangInitialConfig(EMETA_Gang inGang);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetDurationOfLostTerritoryRemembering();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetDurationInsideEnemiesList();
    
    UFUNCTION(BlueprintCallable)
    FMETA_DefenceResultCalculatingConfigForAI GetDefenceResultCalculationConfigForAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetDaysAmountForMoreAttacksk();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetDaysAmountForGangInTopEnemiesListOfAllGangsAfterBreakingTruce();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetDataSetup_IfEnemyTierLowerThanPlayers(float& outMultiplier, FMETA_FloatInterval& outClamp);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetDataSetup_IfEnemyTierHigherThanPlayers(float& outMultiplier, FMETA_FloatInterval& outClamp);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetCountdownForAttackAfterLostTile();
    
    UFUNCTION(BlueprintCallable)
    TArray<FMETA_ConditionForArmyTierChanging> GetConditionsForArmyTierChanging();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetChanceToAttackNeutralTerritoryByAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetChanceToAttackInRetaliatorTactic();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetChanceToAttackAdjacentTerritoryToTheGangFromEnemiesList();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetChanceIncreaseToAttackAnyAdjacentTerritoryByAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetBaseChanceToAttackAnyAdjacentTerritoryByAI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetAttemptsToCaptureTerritory();
    
    UFUNCTION(BlueprintCallable)
    TArray<EMETA_Gang> GetArrayOfGangsWhichCanAttackAnyTile();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_ArmySizeConfigForAI GetArmySizeLimitsByPlayerRespect(EMETA_RespectLvl inRespectLvl);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetAmountOfFriendlyNeighbourTilesToConsiderTileAsConnected();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetAmountOfAttackskForMoreAttacksDays();
    
    UFUNCTION(BlueprintCallable)
    TArray<EMETA_GangStrategy> GetAIStrategiesThatAttackMore();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_Interval GetAIArmySizeForPlayersAttackOnLastTile();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CheckPossibilityToAttackTilesAroundDetective();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CanPlayerLoseAllSentSoldiersAfterFailedDefence();
