...
UIGS_UArmsAniminstance::UIGS_UArmsAniminstance() {
    ...
    this->m_CarryableItemsAnimations = NULL;
    this->m_ThrowableItemsAnimations = NULL;
    this->m_MeleeAnimations = NULL;
    this->m_TPV_AnimInstance = NULL;
    this->m_Weapon_AnimInstance = NULL;
    this->ArmsDownState = NULL;
    this->m_MeleeAttackAnimations = NULL;
    this->m_CameraEffectsAnimation = NULL;
    this->m_SpecialActionsAnimations = NULL;
