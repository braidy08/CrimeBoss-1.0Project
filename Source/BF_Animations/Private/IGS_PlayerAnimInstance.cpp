...
UIGS_PlayerAnimInstance::UIGS_PlayerAnimInstance() {
    ...
    this->m_AIRequestAnimation = NULL;
    this->m_CharacterStateAnimations = NULL;
    this->m_PanicAnimations = NULL;
    this->m_ReactionAnimations = NULL;
    this->m_MovementAnimations = NULL;
    this->m_AnimIntermediaryLinker = NULL;
}




void UIGS_PlayerAnimInstance::TriggerAnimationEvent() const {
}
...
void UIGS_PlayerAnimInstance::OnWeaponChange() {
}
