...
class UBlendSpace;
class UBlendSpace1D;
class UIGS_AIRequestAnimation;
class UIGS_AnimIntermediaryLinker;
class UIGS_CharacterStateAnimations;
class UIGS_InventoryObjectFramework;
class UIGS_MovementAnimations;
class UIGS_PanicAnimations;
class UIGS_ReactionAnimations;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    FIGS_ThirdpersonHolsterAnimation m_HolsterAnimation;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_AIRequestAnimation* m_AIRequestAnimation;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_CharacterStateAnimations* m_CharacterStateAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_PanicAnimations* m_PanicAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_ReactionAnimations* m_ReactionAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_MovementAnimations* m_MovementAnimations;
...
public:
    ...
    void TriggerAnimationEvent() const;
