...
class UIGS_HitReactionsRuntime;
class UIGS_PlayerDownState;
class UIGS_ThirdPersonDeathAnimations;
...
public:
    ...
    UIGS_HitReactionsRuntime* HitReactions;
...
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_PlayerDownState* m_PlayerDownState;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_ThirdPersonDeathAnimations* m_ThirdPersonDeathAnimations;
