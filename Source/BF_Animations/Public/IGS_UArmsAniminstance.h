...
class UIGS_AnimIntermediaryLinker;
class UIGS_ArmsDownState;
class UIGS_CameraEffectsAnimation;
class UIGS_CarryableItemsAnimations;
class UIGS_MeleeAnimations;
class UIGS_MeleeAttackAnimations;
class UIGS_ReloaderBase;
class UIGS_SpecialActionsAnimations;
class UIGS_ThrowableItemsAnimations;
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_CarryableItemsAnimations* m_CarryableItemsAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_ThrowableItemsAnimations* m_ThrowableItemsAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_MeleeAnimations* m_MeleeAnimations;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_ArmsDownState* ArmsDownState;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_MeleeAttackAnimations* m_MeleeAttackAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UIGS_CameraEffectsAnimation* m_CameraEffectsAnimation;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_AimAnimationInfo m_AimAnimationInfo;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_EquipAnimationData m_EqipAnimationData;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_SpecialActionsAnimations* m_SpecialActionsAnimations;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_AnimIntermediaryLinker* m_AnimIntermediaryLinker;
