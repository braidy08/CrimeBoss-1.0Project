...
protected:
    ...
    UFUNCTION(BlueprintCallable, Reliable, Server, WithValidation)
    void MessageToServer_ThrowAwayItem(TSubclassOf<UIGS_InventoryObjectFramework> inInventoryObjectClass, TSubclassOf<UMETA_WeaponInventoryObject> inWeaponId, FIGS_InventoryObjectUniversalData inUniversalData, FTransform InTransform, const TSoftClassPtr<AIGS_PickupActorBase>& inCustomPickupClass);
...
protected:
    ...
    UFUNCTION(BlueprintCallable, Reliable, Server, WithValidation)
    void MessageToServer_DropDownItem(TSubclassOf<UIGS_InventoryObjectFramework> inInventoryObjectClass, TSubclassOf<UMETA_WeaponInventoryObject> inWeaponId, FIGS_InventoryObjectUniversalData inUniversalData, FTransform InTransform, const TSoftClassPtr<AIGS_PickupActorBase>& inCustomPickupClass);
