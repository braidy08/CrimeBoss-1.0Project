...
public:
    ...
    UFUNCTION(BlueprintCallable)
    bool SelectEquipment(TSubclassOf<UIGS_EquipmentInventoryObject> inCurrentEquipment);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_CharacterTier GetQualityTier() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBaseUpkeepCost();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBaseMissionCutPercent();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetBaseLevelUpMultiplier();
    ...
    UFUNCTION(BlueprintCallable)
    TArray<TSubclassOf<UIGS_EquipmentInventoryObject>> ClearEquipment();
    
    UFUNCTION(BlueprintCallable)
    void ClearAndReturnWeaponFromSlot(EIGS_InventorySlot inSlot, UMETA_Weapon*& outWeapon);
    ...
    UFUNCTION(BlueprintCallable)
    void AddEquipment(TSubclassOf<UIGS_EquipmentInventoryObject> inEquipment);
