...
FIGS_CarryableTableRow UIGS_CarryableDatabase::GetDataCarryable(UObject* inWCO, const TSubclassOf<UIGS_CarryableInventoryObject>& inClass, bool& outSucceeded) {
